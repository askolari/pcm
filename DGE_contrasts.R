...
counts <- read.csv("C:/Users/agsko/dev/pcm/filtered_genes_with_normalized_counts.csv", row.names = 1)
...
# Double-check that everything aligns correctly
stopifnot(all(rownames(dge_results) == rownames(dge_filtered$genes)))
