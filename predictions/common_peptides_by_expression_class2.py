...
for file_path in file_paths:
    sample_name = file_path.split('/')[-1].replace('_matched_class2.csv', '')  # Get the sample name from the file path
    try:
...
# Save to a new file
output_file = "/mnt/c/Users/agsko/dev/pcm/predictions/common_peptides_in_different_samples_class2.csv"
